...
class HistorienFenster(QWidget):
    ...
    def _build_datei_panel(self) -> QGroupBox:
        ...
        btn_clear.setStyleSheet("""
            QPushButton {
                background: #f1f5f9; border: 1.5px solid #94a3b8;
                border-radius: 4px; color: #334155; font-size: 10px; padding: 4px 8px;
            }
        ...
        hinweis.setStyleSheet("font-size: 9px; color: #888;")
    ...
    def _build_sensor_auswahl(self) -> QGroupBox:
        ...
        # Druck
        lbl_d = QLabel("── Druck ──")
        lbl_d.setStyleSheet("font-size: 9px; color: #888; font-weight: bold;")
        ...
        lbl_t.setStyleSheet("font-size: 9px; color: #888; font-weight: bold; margin-top: 6px;")
